...
1. Creating a new CMS entry:

![](images/article-cms-solution.png)

2. Resource group and all the resources created during this project:

![Resoruce group](images/azure-portal-resource-group.png)

3. Created tables and one query of data from the initial scripts:

![SQL storage](images/sql-storage-solution.png)

4. Example of BLOB endpoints for where images are sent for storage:

![BLOBs](images/blob-solution.png)

5. Redirect URIs related to Microsoft authentication:

![URI redirects](images/uri-redirects-solution.png)

6. Logging of "Invalid login attempt" and "admin logged in successfully":

![Logs](images/log-solution.png)
